...
pub fn variant (self , variant : StartingSlotA) -> & 'a mut W { self . bits (variant . into ()) } # [inline (always)]
pub fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x0f << 0)) | ((value as u8 & 0x0f) << 0) ; self . w } } # [doc = "The number of contiguous superframe slots over which this guaranteed time slot is active."]
# [derive (Clone , Copy , Debug , PartialEq)]
...
pub fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x0f << 4)) | ((value as u8 & 0x0f) << 4) ; self . w } } impl R { # [inline (always)]
