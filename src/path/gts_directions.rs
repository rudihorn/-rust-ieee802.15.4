...
pub fn variant (self , variant : DirectionsMaskA) -> & 'a mut W { self . bits (variant . into ()) } # [inline (always)]
pub fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x7f << 0)) | ((value as u8 & 0x7f) << 0) ; self . w } } impl R { # [inline (always)]
